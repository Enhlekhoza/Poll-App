...
export default function AdminPage() {
  // ... (useState, fetchData, useEffect, handleDeletePoll remain the same)
            ...
            <TableBody>
              {polls.map((poll) => (
                <TableRow key={poll.id}>
                  ...
                  <TableCell>
                    <Button variant="destructive" size="sm" onClick={() => handleDeletePoll(poll.id)}>
                  ...
                  <TableCell>
                    <Select value={user.role} onValueChange={(newRole) => handleRoleChange(user.id, newRole)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="PREMIUM_CREATOR">Premium Creator</SelectItem>
